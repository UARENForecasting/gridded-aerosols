...
#################################################################################
# GEOS5 is initialised at 1200UTC available to download from approx 19-20UTC    #
# ready for inclusion in foreacsts initialised in WRF at 0000UTC the next day.  #
#                                                                               #
# Run at 2015UTC (should finish about 2030UTC) ready to run WPS at 2045UTC      # 
#################################################################################
...
times = ['00','03','06','09','12','15','18','21','00','03','06','09','12','15','18','21','00']
...
for i in range(len(times)):
    ...
    file_name = str('GEOS.fp.fcst.inst1_2d_hwl_Nx.'+year+month+day+'_12+'+str(forecast_strs[d])[:4]+str(forecast_strs[d])[5:7]+str(forecast_strs[d])[8:10]+'_'+times[i]+'00.V01.nc4')
    print (file_name)
